...
export const clientDocuments = pgTable("client_documents", {
  ...
  meetingAttendees: jsonb("meeting_attendees").$type<string[]>(),
  meetingActionItems: jsonb("meeting_action_items").$type<{ text: string; assignee?: string; dueDate?: string }[]>(),
  meetingDecisions: jsonb("meeting_decisions").$type<string[]>(),
  meetingPainPoints: jsonb("meeting_pain_points").$type<string[]>(),
  meetingOpportunities: jsonb("meeting_opportunities").$type<string[]>(),
  meetingPullQuotes: jsonb("meeting_pull_quotes").$type<{ quote: string; speaker?: string; title?: string; context?: string }[]>(),
