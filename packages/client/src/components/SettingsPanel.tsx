...
const defaultTiles: TileConfig[] = [
  ...
  },
  {
    ...
    description: "Browse client quotes, approve testimonials, and track award history",
  ...
  },
  {
    ...
    description: "All case studies, testimonials, awards, and proposals organized by client",
