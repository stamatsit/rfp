          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              {!isLoading && assets.length > 0 && (
                <p className="text-[10px] text-slate-500 dark:text-slate-400 leading-tight">{assets.length} asset{assets.length !== 1 ? "s" : ""}</p>
              )}
            </div>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center gap-3 py-12 text-center px-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Save SVGs, images, and snippets from the AI sidebar</p>
              </div>
            </div>
          ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-slate-500 dark:text-slate-400 capitalize">{typeLabels[asset.type] ?? asset.type} &middot; {new Date(asset.createdAt).toLocaleDateString()}</p>
                    </div>
                    <button
