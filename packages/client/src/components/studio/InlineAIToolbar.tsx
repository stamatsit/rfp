...
export function InlineAIToolbar({ selectedText, position, documentContext, onApply, onClose }: InlineAIToolbarProps) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.12),0_0_0_1px_rgba(0,0,0,0.04)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_0_1px_rgba(255,255,255,0.06)] overflow-hidden"
        style={{ minWidth: 300, maxWidth: 400 }}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-3 py-1.5 bg-gradient-to-r from-emerald-500 to-teal-500 text-white">
          <div className="flex items-center gap-1.5">
            <Sparkles className="w-3 h-3" />
            <span className="text-[11px] font-semibold">AI Edit</span>
          </div>
        ...
        <div className="px-3 py-2 border-b border-slate-100/80 dark:border-slate-700/60">
          <p className="text-[9px] font-semibold text-slate-400 dark:text-slate-500 mb-0.5 uppercase tracking-wider">Selected text</p>
