...
export const CHAT_THEMES = {
  ...
  crimson: {
    ...
    primary: "crimson",
    botGradient: "linear-gradient(135deg, #C41230 0%, #96173F 50%, #6D1D45 100%)",
    botShadow: "0 4px 12px rgba(196,18,48,0.35), inset 0 1px 0 rgba(255,255,255,0.2)",
    userBubbleBg: "bg-gradient-to-br from-rose-50 to-red-100/80",
    userBubbleBorder: "border-rose-200/60",
    userBubbleShadow: "shadow-[0_1px_3px_rgba(196,18,48,0.1)]",
    accentBg: "bg-rose-50",
    accentBgHover: "hover:bg-rose-100",
    accentText: "text-rose-700",
    accentBorder: "border-rose-200",
    accentBgDark: "dark:bg-rose-900/30",
    accentBgHoverDark: "dark:hover:bg-rose-900/50",
    accentTextDark: "dark:text-rose-300",
    accentBorderDark: "dark:border-rose-700",
    sendButtonGradient: "bg-gradient-to-r from-[#C41230] to-rose-600",
    sendButtonHoverGradient: "hover:from-[#A80F29] hover:to-rose-700",
    sendButtonShadow: "shadow-[0_4px_12px_rgba(196,18,48,0.3)]",
