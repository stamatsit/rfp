...
const categoryMeta: Record<string, CategoryInfo> = {
  ...
  "Image Toolkit": { icon: <ImageDown size={20} />, color: "text-emerald-500", bg: "bg-emerald-50" },
...
const helpArticles: HelpArticle[] = [
  ...
  // Image Toolkit
  {
    ...
    question: "What is the Image Toolkit?",
    answer: "The Image Toolkit is an all-in-one image editing suite built right into the app. It lets you convert between formats (WebP, PNG, JPEG), crop and resize to exact dimensions using social media presets, remove backgrounds with AI, and erase unwanted objects with the Magic Eraser. You can process multiple images at once and download them individually or as a ZIP. Everything runs in your browser — no files are uploaded to any server.",
  },
  {
    id: "img-2",
    category: "Image Toolkit",
    question: "How do I convert and download an image?",
    answer: "Navigate to Image Toolkit from the sidebar or home page. Drop an image (or click to browse), choose your output format (WebP, PNG, or JPEG) from the format picker, adjust quality if needed (default 80% for WebP), and hit Download. You can also switch to Crop mode first to interactively crop or resize before downloading.",
  },
  {
    id: "img-3",
    category: "Image Toolkit",
    question: "What output formats are supported?",
    answer: "You can export to WebP, PNG, or JPEG. WebP produces the smallest files with minimal quality loss. PNG preserves transparency (great after background removal). JPEG is widely compatible. Choose the format from the dropdown before downloading.",
  },
  {
    id: "img-4",
    category: "Image Toolkit",
    question: "How do I crop and resize for social media?",
    answer: "Switch to Crop mode and pick a preset from the dropdown — there are ready-made sizes for Instagram (Post, Story, Reel), Facebook (Post, Cover, Story), X/Twitter, LinkedIn, YouTube, and common web dimensions (OG Image, HD 1080p, 4K). You can also type custom width and height values. The crop area locks to the chosen aspect ratio so you get pixel-perfect output.",
  },
  {
    id: "img-5",
    category: "Image Toolkit",
    question: "How does background removal work?",
    answer: "Select an image and click the 'Remove BG' button. An AI model runs entirely in your browser to remove the background, leaving just the subject on a transparent canvas. The format automatically switches to PNG or WebP to preserve transparency. You can undo the removal at any time to restore the original.",
  },
  {
    id: "img-6",
    category: "Image Toolkit",
    question: "What is the Magic Eraser?",
    answer: "The Magic Eraser lets you paint over unwanted objects, text, or blemishes in an image and the AI fills in the area naturally. Switch to Erase mode, adjust the brush size, paint over the area you want removed (highlighted in magenta), then click Apply. The AI inpainting model runs locally in your browser. You can undo strokes before applying, or undo the entire erase after applying.",
  },
  {
    id: "img-7",
    category: "Image Toolkit",
    question: "Can I process multiple images at once?",
    answer: "Yes — drop or select multiple images and they appear in a filmstrip below the preview. Click any thumbnail to select it. You can download all images at once as a ZIP file. Drag thumbnails to reorder them. Use the batch rename feature to give all images a consistent naming pattern with a custom prefix, separator, and numbering.",
  },
  {
    id: "img-8",
    category: "Image Toolkit",
    question: "Does the Image Toolkit save my work?",
